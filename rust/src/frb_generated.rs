...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -239628109;
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::start_download(api_device_id, api_first)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__clear_calibration_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__configure_deploy_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__configure_lora_transmission_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__configure_name_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__configure_wifi_networks_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__configure_wifi_transmission_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__create_log_sink_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__get_my_stations_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__register_portal_account_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__rust_release_mode_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__start_download_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__start_native_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__start_upload_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__upgrade_station_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__validate_tokens_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__verify_lora_transmission_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
